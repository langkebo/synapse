...
-- 为搜索历史表创建索引
CREATE INDEX IF NOT EXISTS friend_search_history_user_idx ON friend_search_history(user_id);
CREATE INDEX IF NOT EXISTS friend_search_history_ts_idx ON friend_search_history(search_ts);